...
function NavLink({ to, children }){
  ...
  return (
    <a href={to} onClick={(e)=>{e.preventDefault(); history.pushState({}, "", to); dispatchEvent(new PopStateEvent('popstate'));}}
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 grid gap-4 md:grid-cols-3">
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="/media" className="w-8 h-8 flex items-center justify-center rounded-full border border-white/10 hover:border-[#d4af37] hover:bg-white/5 transition-all" aria-label="YouTube">YT</a>
            </div>
          </div>
